...
const SearchMesssage = () => {
  ...
  const onSearchMessage = (value) => {
    searchMessage({variables: {messageQuery: {conversationId: currentConversation._id, searchText: value}}})
  }
            ...
            renderItem={item => (
              ...
              >
                <List.Item.Meta
                  ...
                  title={<div className='list-description'>{item.senderId === currentUserId ? 'Bạn: ' : ''} {item.message}</div>}
                />
              </List.Item>
            )}
          >

...
import {Settings, Edit, MessageCircle, Users, Search, LogOut, Edit3, PlusCircle, Image} from 'react-feather';
...
import {CREATE_CONVERSATION, GET_USER_LIST, UPDATE_USER} from "../queries/message";
  ...
  const userInfo = (
    <Header className="sidebar-left__header">
      <Row align="middle" style={{width: '100%'}}>
        <Col span={12}>
          <Space>
            <Dropdown overlay={userSetting} placement="bottomLeft" arrow trigger={['click']}>
              <Avatar style={{cursor: "pointer"}} src={currentUser?.avatarFile?.url} />
            </Dropdown>
        ...
        <Col span={3}>
          <Tooltip title="Create new group chat">
            <PlusCircle size={20} strokeWidth={1.5} onClick={(visible) => setVisible(true)} />
          </Tooltip>
        </Col>
      </Row>
    </Header>
